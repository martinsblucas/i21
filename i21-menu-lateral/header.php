...
<html lang="pt-br" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <link rel="icon" href="<?php bloginfo('template_directory'); ?>/img/fav/favicon-16.png?v=6" sizes="16x16">
    <link rel="icon" href="<?php bloginfo('template_directory'); ?>/img/fav/favicon-32.png?v=6" sizes="32x32">
  ...
  <body <?php body_class(); ?>>
        ...
        <div class="container">
          ...
          <form class="search-form" id="searchform" role="search" method="get" action="<?php bloginfo("url"); ?>">
                    <div class="form-group pull-right" id="search">
                      ...
                      <input type="hidden" name="v" id="v" value="<?php $_GET["v"] === $v; if ($v = 2) { echo "2"; } else { } ?>" />
    ...
    <main class="container topo">
    	<header class="row" id="header">
			...
			elseif (is_archive()) {
				...
				$link = get_the_permalink() . "?v=1";
			}
			?>
            <a href="<?php echo $link; ?>"><i class="fas fa-ellipsis-h"></i></a>
            </div>
            ...
            <div class="col-3 col-md-1 redes">
    ...
    <div class="col-12 col-md-3 col-lg-3 menu-vertical">
    ...
    <nav class="navbar navbar-expand-md col-12" role="navigation">
                  <div class="navbar-right d-block d-md-none d-lg-none">
            		<form class="search-form-m" id="searchform" role="search" method="get" action="<?php bloginfo("url"); ?>/?v=2">
                    <div class="form-group pull-right" id="search">
                      <input type="text" class="form-control" placeholder="Pesquisar" name="s" id="s" value="<?php the_search_query(); ?>">
                      <input type="hidden" name="v" id="v" value="<?php $_GET["v"] === $v; if ($v = 2) { echo "2"; } else { } ?>" />
                      <button type="submit" id="searchsubmit" class="form-control form-control-submit">Submit</button>
    ...
    <div class="col-12 col-md-9 col-lg-9 navegacao-site">